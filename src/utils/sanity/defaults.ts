...
export const DEFAULT_HOME_PROCESS: HomeProcessContent = {
	...
	steps: [
		...
		{title: 'Project Handover', description: 'Final walkthrough and complete documentation package.'},
	],
}
...
export const DEFAULT_SERVICES_PAGE: ServicesPageContent = {
	...
	description:
		'From a single bathroom refresh to a complete home transformation — we offer a full range of renovation and interior finishing services, delivered with precision and care.',
	...
	processSteps: [
		...
		{icon: 'fa-solid fa-file-signature', title: 'Signed Contract', body: "Once you're happy, we formalise everything in a clear contract. Scope, schedule, and payment milestones — all in writing."},
		...
		{icon: 'fa-solid fa-flag-checkered', title: 'Final Walkthrough', body: 'We walk the finished project with you. Any snags are addressed before final payment. You sign off when you are satisfied.'},
	],
	// Pricing hint
...
export const DEFAULT_ABOUT_PAGE: AboutPageContent = {
	...
	whoPills: ['Licensed & Insured', 'Trusted Since 2016', 'Local Team', 'No Subcontracting Surprises'],
	...
	timeline: [
		...
		{year: '2021', title: '50 Projects Completed', text: "A milestone year. We complete our 50th project and formalise our commitment to quality — clear written contracts, staged payment schedules, and documented quality checks for every client.", highlight: false},
	...
	valueCards: [
		...
		{icon: 'fa-solid fa-phone', num: '06', title: 'Available After Handover', body: "Our relationship doesn't end when we leave the site. We stand behind every project — our clients know they can call us anytime, for anything."},
	],
	// Team
	...
	certDescription: "We're fully licensed, insured, and certified. Every project meets or exceeds BC Building Code requirements.",
	certBadges: [
	...
	guaranteeCards: [
		{icon: 'fa-solid fa-file-contract', title: 'Detailed Written Contracts', text: 'Every project begins with a clear, signed contract. Scope of work, payment schedule, timeline — all in writing, before we touch a thing.'},
...
export const DEFAULT_SERVICES: ServiceDetail[] = [
	{
		...
		meta: [{key: 'Typical Duration', val: '2 – 4 Weeks'}],
	...
	},
	{
		...
		meta: [{key: 'Typical Duration', val: '4 – 8 Weeks'}],
	...
	},
	{
		...
		meta: [{key: 'Typical Duration', val: '2 – 5 Weeks'}],
	...
	},
	{
		...
		meta: [{key: 'Typical Duration', val: '8 – 16 Weeks'}],
	...
	},
	{
		...
		meta: [{key: 'Typical Duration', val: '3 – 10 Days'}],
	...
	},
	{
		...
		meta: [{key: 'Typical Duration', val: '3 Days – 3 Weeks'}],
